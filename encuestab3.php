...
<body>
  <center>
    ...
    <br>
    <form action="evalua_orientacion3.php" method="post">
      ...
      <table class="tg table table-hover">
        ...
        <tr>
          <td class="tg-5tbv">Opción 1° Me llama la atención como hacer una instalación eléctrica<br><br>Opción 2° Me
            interesa trabajar en proyectos sobre tecnologías y comunicación</td>
        ...
        <tr>
          <td class="tg-bnwb">Opción 1° Me llama la atención el uso de equipos de medición de electricidad (multímetro,
            amperímetro, etc)<br><br>Opción 2° Me agrada preparar ricos e innovadores platillos</td>
        ...
        <tr>
          <td class="tg-5tbv">Opción 1° Me gusta el área Industrial<br><br>Opción 2° Me llama la atención conocer el
            desarrollo de nuevos productos en el mercado</td>
