...
?>
  ...
  <body>
    <center>
      ...
      <form action="evalua_orientacion5.php" method="post">
        ...
        <table class="tg table table-hover">
          ...
          <tr>
            <td class="tg-5tbv">Opción 1° Me llama la atención realizar programas de computadoras en distintos
              lenguajes<br><br>Opción 2° Me agrada la preparación de bebidas y cocktails</td>
          ...
          <tr>
            <td class="tg-bnwb">Opción 1° Me llama la atención como dos dispositivos móviles se conectan entre
              si<br><br>Opción 2° Me llama la atención implementar programas que contribuyan al ahorro de energía
              eléctrica</td>
          ...
          <tr>
            <td class="tg-5tbv">Opción 1° Me agradar aprender a darle mantenimiento a una computadora<br><br>Opción 2°
              Me interesa conocer las decisiones que toman las personas para adquirir un producto</td>
