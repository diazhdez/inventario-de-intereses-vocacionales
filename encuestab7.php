...
<body>
  <center>
    ...
    <form action="evalua_orientacion7.php" method="post">
      ...
      <table class="tg table table-hover">
        ...
        <tr>
          <td class="tg-5tbv">Opción 1° Me gusta la reparación de aparatos electrodomésticos (refrigeradores,
            televisiones, aires acondicionados, etc)<br><br>Opción 2° Me interesa aprender a diseñar bases de datos para
            sistemas de información</td>
        ...
        <tr>
          <td class="tg-bnwb">Opción 1° Me llama la atención la electrónica<br><br>Opción 2° Me agradaría participar en
            eventos gastronómicos</td>
        ...
        <tr>
          <td class="tg-5tbv">Opción 1° Me llama la atención los equipos de seguridad industrial<br><br>Opción 2° Me
            agrada llevar acabo la planeación y verificación de presupuestos al momento de iniciar un proyecto</td>
