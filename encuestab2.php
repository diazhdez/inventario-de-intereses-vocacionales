...
<body>
  <center>
    ...
    <form action="evalua_orientacion2.php" method="post">
      ...
      <table class="tg table table-hover">
        ...
        <tr>
          <td class="tg-5tbv">Opción 1° Me agrada cocinar<br><br>Opción 2° Me interesa aprender cómo se crea una red de
            internet</td>
        ...
        <tr>
          <td class="tg-bnwb">Opción 1° Me interesa saber sobre nutrición<br><br>Opción 2° Me llama la atención el
            funcionamiento de un equipo de aire acondicionado</td>
        ...
        <tr>
          <td class="tg-5tbv">Opción 1° Me agrada conocer nuevas técnicas culinarias<br><br>Opción 2° Me interesan los
            artículos de temas relacionados con el marketing y publicidad.</td>
