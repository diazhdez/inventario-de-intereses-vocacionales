...
<body>
  <center>
    ...
    <form action="evalua_orientacion4.php" method="post">
      ...
      <table class="tg table table-hover">
        ...
        <tr>
          <td class="tg-5tbv">Opción 1° Me llama la atención las técnicas que las empresas utilizan para que las
            personas compren sus productos o servicios<br><br>Opción 2° Me interesa aprender como conectar un grupo de
            computadoras a una red de internet</td>
        ...
        <tr>
          <td class="tg-bnwb">Opción 1° Me llama la atención la creación y producción de comerciales
            publicitarios<br><br>Opción 2° Me llama la atención la elaboración de pasteles</td>
        ...
        <tr>
          <td class="tg-5tbv">Opción 1° Me llama la atención la forma en que las empresas realizan sus ventas en
            línea<br><br>Opción 2° Me agradaría participar en proyectos industriales</td>
